...
public class QsTileLayoutSettings extends SettingsPreferenceFragment
    ...
    private static final int MIN_QS_COLUMNS = 2;
    private static final int MIN_QS_ROWS = 2;
    private static final int MIN_QQS_ROWS = 1;
