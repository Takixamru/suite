...
public class QuickSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_OOS_QS_STYLE  = "oos_qs_style";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mOOSQsPref = findPreference(KEY_OOS_QS_STYLE);
        mOOSQsPref.setOnPreferenceChangeListener(this);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQuickPulldown) {
            ...
            return true;
        } else if (preference == mOOSQsPref) {
            Settings.Secure.putIntForUser(resolver,
                    "oos_qs_style", 0, UserHandle.USER_CURRENT);
            InfinityUtils.showSystemUIRestartDialog(getActivity());
            return true;
        }    
        return false;
